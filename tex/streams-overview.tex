...
The Milky Way is currently in significant disequilibrium due to an \changes{ongoing} merger with the LMC \citep[e.g.,][]{besla:2007,kallivayalil:2013,vasiliev:2024}, which is expected to result in large variations of subhalo impacts on streams with different orbits \citep{barry:2023,arora:2023}.
