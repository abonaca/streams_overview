...
limit.
The stream tracks in Figure~\ref{fig:msto-rc-mag} were determined by fitting orbits to
stream stars associated with each stream using data from \citet{ibata:TODO} (this
procedure is described in detail in \ref{apx:stream-fit}).
...
\begin{figure*}[t!]
    ...
    the streams in \citet{ibata:TODO} (this procedure is described in detail in
    \ref{apx:stream-fit}).
