...
Figure~\ref{fig:sky-map} shows the on-sky footprints of all \changes{XX} currently known stellar streams in the Milky Way, as listed in Table~\ref{tbl:stream-summary}.
...
\changes{First}, typical mass of stellar streams ($\approx10^4\,\unit{\msun}$, see Table~\ref{tbl:stream-summary}) \changes{is} lower than that of globular clusters \citep[$\approx10^5\,\unit{\msun}$,][]{baumgardt:2018}.
...
Currently 76 of the 131 known \changes{stellar} streams reside within the extent of the stellar disk ($\lesssim15\,\unit{kpc}$, Table~\ref{tbl:stream-summary}), where baryons \changes{have a significant contribution to} the gravitational potential \citep[e.g.,][]{mcmillan:2017}.
