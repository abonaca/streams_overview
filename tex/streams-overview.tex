...
% Using an even larger sample of \gaia\ metallicities \citep{andrae:2023}, across the tails \citep{cunningham:2024}, consistent with a radial metallicity gradient within the progenitor.
...
% More recently, \citet{cunningham:2024} used an even larger sample of \gaia\ metallicities \citep{andrae:2023} to detect a metallicity gradient both along and across the Sagittarius tails, and map it to the radial metallicity gradient in the progenitor.
% - dwarf galaxy streams similar metallicity compared to low-mass bound dwarfs
% - also similar gradients -- sgr, johnson, cunningham
% - mainly served to confirm the origin
% - however, detailed abundances: 
