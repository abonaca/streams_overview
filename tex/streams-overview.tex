...
\todo{Add galactocentric distance}
\todo{Remove dist range columns}
\todo{Sort by name and seen in gaia column. Or maybe two separate tables for seen in gaia vs not?}
