...
\begin{abstract}
The hierarchical model of galaxy formation predicts that the Milky Way halo is populated by tidal debris of accreted satellites.
Due to long dynamical times, debris from the lowest mass satellites remain coherent as thin and dynamically cold stellar streams for billions of years.
% , and therefore sensitive to the underlying gravitational potential.
...
% First, more than a hundred stellar streams have been discovered and characterized using \gaia\ data between YY\,kpc and XX\,kpc from the Galactic center.
...
% Dark-matter subhalos, as well as baryonic structures were theoretically predicted to form such features, but because of their low surface brightness, they haven't been detected until \gaia.
Dark-matter subhalos, as well as baryonic structures were theoretically predicted to form such features, but they have been observationally disputed before \gaia.
...
Perhaps most excitingly, the comparison between the two will be able to reveal the presence of dark-matter subhalos below the threshold for galaxy formation ($\lesssim10^6\,\unit{\msun}$), and thus validate the LCDM cosmology. 
% kinematically too to determine the origin of perturbations and confronted w realistic simulations in different cosmologies to ultimately determine the nature of dark matter.
% These discoveries open opportunities
% Implications heralding exciting times ahead! -- detecting the presence of dm subhalos below the threshold for galaxy formation ($\lesssim10^6\,\unit{\msun}$), staple of lcdm cosmology
% -- to do that, precise structure and kinematics for an entire population of stellar streams
% -- realistic models, take into account various sources of perturbation + different dm models
% -- population based modeling frameworks
% 
% theoretically predicted, dynamical perturbations, proof-of-principle
...
% - comparison to other halo denizens
- orbital poles
