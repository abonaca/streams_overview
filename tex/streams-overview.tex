...
\begin{figure*}[t!]
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/rv_signal.pdf}
\end{center}
\caption{%
...
Due to the increased scatter, the radial velocity signature of the perpendicular impact is marginally resolved (bottom left), while that of the grazing impact is washed away and indistinguishable from the gap associated with the dissolved progenitor (bottom center).
This numerical experiment suggests that the origins of stream gaps can be discovered using radial velocities if our precision for measuring them increases by an order of magnitude.
