...
Full table consisting of $80,162$ unique stars, and additional columns with measurement uncertainties, correlations and chemical abundances, is available on the project Github and Zenodo repositories.
}
}
\label{tbl:members}
\end{table*}
