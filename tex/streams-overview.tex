...
over 120 streams have now been reported in the literature, with more discoveries coming
every year, especially enabled by new data releases from \gaia\ and new methodological
developments.
- Some streams better than others, exemplars
- Each stream is unique in story it can tell
- Many still need validation -- spectroscopy can be a challenge (see right panel of Fig blah)
- Immediate interpretation of population of observed streams in context of population of all streams hard because of selection effects.
- Need to understand selection function and contamination rate of stream finders, which requires observing (hard!) and publishing null results / non-discoveries
