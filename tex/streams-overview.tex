...
\label{eq:angle}
\\
\Omega_i(\pmb{J}) &\equiv \dot{\theta}_i = \frac{H}{J_i}
\label{eq:frequency}
\end{align}
...
% The orbital phase space of streams as a population has provided further insights in the hierarchical assembly of our Galaxy.
% - space of orbital poles -- not clustered in the plane \citep{riley}
% - unlike dwarf galaxies -- possibly different time (look up pawlowski, garavito-camargo latest)
% - another informative space: E-Lz instantaneous properties, can be determined for every potential
% - streams clustered (seen even in Figure~) \citep{bonaca:2021, malhan:2022}
% - clustering -- associated with accretion origin, way to identify mw progenitors
% - stream clusters aligned with field halo clusters, possible to map to progenitor dwarf galaxies

% - group infall: previous dwarf findings for mw orbital associations, dwarf satellites (deason; patel)
- implications for structure of streams: generally expect cocoons (carlbergs, malhans)
