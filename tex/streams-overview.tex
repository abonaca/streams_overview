...
The Jhelum stream \citep{shipp:2018} was discovered using photometry from the Dark
Energy Survey (DES) and later confirmed using proper motion measurements from \gaia\
\dr{2} \citep{shipp:2019}.
