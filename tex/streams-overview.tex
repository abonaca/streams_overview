...
The first stream to be studied in detail in the context of the Galactic bar was the
Ophiuchus stream \citep{bernard:2014, sesar:2015, sesar:2016}.
...
$\sim 3~\kpc$) given the expected age of the stream, and therefore the time over which
it could have phase mixed \citep{caldwell:2020}.
