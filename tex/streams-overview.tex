...
Figure~\ref{fig:XX} is a recreation of ... now using data from \gaia\ \dr{3} ... which demonstrates the power of using \gaia\ astrometry to filter for stream members.
- TODO: make and describe figure
