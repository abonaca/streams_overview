...
Their mass function indicates globular clusters are a product of regular clustered star formation (\S\ref{sec:orbits}).
...
We expect that all of these aspects will be further developed in the future, but perhaps the most exciting prospect for streams is constraining the nature of dark matter.

We propose that the goal for the next decade should be an unambiguous association of a stream perturbation with a dark subhalo ($\lesssim10^6\,\unit{\msun}$).
