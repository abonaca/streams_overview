...
Figure~\ref{fig:phase_space} reveals these connections: some of the streams coincide with the Milky Way globular clusters (light blue circles) and dwarf galaxies (dark blue circles) in the $E-L_z$ plane--their progenitors.
...
Despite these peculiarities, this now sizeable subset of stellar streams with known globular cluster progenitors forms a valuable sample for gravitational potential inference.
Controlling for the progenitor improves modeling , otherwise the progenitor a free parameter \citep{palau:2023}
can also fit the overdensities \citep{kupper:2015}
...
- environment:
- streams in full hydro, tailored mw
