...
- in static axisymmetric potentials conserved properties, phase space useful framework
- even though perturbations, some orbital properties approximately conserved
- exactly so in certain potentials, used theoretically to quickly generate streams
- now available observationally: findings for individual streams

- orbital frequencies, conserved even in time-evolving potentials
- regular orbits -- stream map to constrain the potential?
- resonant orbits -- higher dispersal rate?
- sgr on 1:2 resonance (koppelman)

- orbital phase space from the stream population
...
- cetus-palca, for group infall (yuan, chang, thomas)
- may even explain the long-standing puzzle of the sgr bifurcation (penarrubia, recent disk claim) as group infall (davies)
- group infall: previous dwarf findings for mw orbital associations, dwarf satellites
