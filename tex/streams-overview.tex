...
C-19 on the other hand has unexpecteldy large width and velocity dispersion for a cluster of its mass, possibly due to having formed in a dark matter halo instead \citep{errani:2022}.
...
The interplay of these processes may depend on both the age and the mass of the cluster, so globular cluster streams---old and low-mass---provide a new regime for developing the physical picture of cluster formation.



% However, it is still uncertain to how they are balanced during the cluster formation \citep[e.g.,][]{bastian:2018,gratton:2019}, so detection o provides a valuable empirical data point in old, low-mass systems.
