...
Early theoretical models of interacting galaxies showed that reproducing the various configurations of tail and bridge features seen in catalogs of interacting galaxies \citep{arp, others} is possible through gravity alone \citep{toomre, tt}.
Their tidal origin makes streams extremely powerful tracers of the underlying gravitation field and dark matter, which dominates the mass budget in most galaxies \citep[e.g.,][]{moster, behroozi}.
...
Extragalactic streams provide somewhat limited constraints on the potential because they have only been detected in 2D projected sky coordinates \citep{nibauer:2023}, but for the Milky Way streams, especially in the era of Gaia, we have been able to measure both the 3D positions and 3D velocities.
Immediately upon the discovery of first Milky Way streams, theoretical studies showed that the phase space of stellar streams can be used to measure the mass and shape of a dark matter halo on large scales \citep{varghese:2011, bonaca:2014}, and to measure the abundance of dark-matter subhalos on small scales \citep{johnston:2002, ibata:2002}.
With this, stellar streams are poised to answer one of the major open questions in both physics and astrophysics---the nature of dark matter.

The first Milky Way stream to be discovered, tidal tails of the Sagittarius dwarf galaxy \citep{ibata:1994}, was also the first one used to constrain the shape of the Milky Way's dark matter halo. 
- traced to wrap around more than 360deg \citep{majewski, belokurov}, almost great circle -- potential close to spherical
...
- kinematics key \citep{bh:2018}
- spectroscopy is more time-consuming than photometry, in addition targets are sparse \citep{kuzma, etc}, so follow-up inefficient
...
\emph{The availability of stream kinematics, needed for accurate potential reconstruction, was limited pre-\gaia.}
...
As a demonstration of this, Figure~\ref{fig:XXX} shows the distribution of $G$-band
magnitudes for the MSTO and HB of 87 known streams.
TODO: explain how we get distances... plot phi1 vs. G ?
\todo{Plot or some characterization of G or V magnitude of stream MSTO location? Histogram of MSTO magnitude and RGB magnitude at logg = 1 for all streams}
