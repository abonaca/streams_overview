...
In this section we describe what is needed to turn streams into ultimate dark matter detectors.


\subsection{Data}
The first observational frontier for the next decade is quite literal: revealing streams in the outer Milky Way.
...
While clean tracers of dark matter, detecting streams at distances $\gtrsim20\,\unit{kpc}$ has been challenging.
For example, a $10^4\,\unit{\msun}$ stream at a distance of 50kpc would have a parallax of x, pms of y, and surface brightness of z -- all outside of current detection capabilities.



- reason to believe the stream sample is incomplete: gc sims predict number of clusters in mw-like galaxies initially
In addition, our estimates of stream masses indicate that even lower-mass clusters can form

% Accordingly, dark matter dominates beyond $\gtrsim20\,\unit{kpc}$
