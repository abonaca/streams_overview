...
% what the subhalo impact rates on streams imply for the overall abundance of the dark matter substructure and the nature of dark matter, we need to account for the Milky Way's accretion history.
% , emphasizing the importance of tailored forecasts for the subhalo encounter rates that match the Milky Way's accretion history.
% To interpret properties of any given stream in the context of dark matter substructure, we need to account for the global structure of the host dark matter halo, as well as the orbit and origins of the stream itself.

- stream orbit: from origin to baryonic perturbers
- putting everything together will require novel ways of solving multi-scale gravitational dynamics.
- possibly using genetic modification algorithms or semi-analytic approaches
