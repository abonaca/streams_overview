...
% Due to high scatter, the radial velocity signature is only marginally resolved at the present (bottom left), while that of a grazing impact would be washed away and indistinguishable from the gap associated with the dissolved progenitor (bottom center).
